  ...
  //Help function
    ...
    if (command === "help" && args[0] === "diopter") {
      ...
      .addFields(
        {
        name:  `\\maxfps <camera>`,
        value: `Displays the maximum frames per second in different sensor modes for a given camera.\n
                Available cameras:\n
                mini - ARRI ALEXA Mini\n
                alexaxt - ARRI ALEXA XT\n 
                alexasxt - ARRI ALEXA SXT W\n 
                minilf - ARRI Mini LF\n 
                alexalf - ARRI ALEXA LF\n 
                amira - ARRI AMIRA\n 
                venice - SONY VENICE`
        }
      )
